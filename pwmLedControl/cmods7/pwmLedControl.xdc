...
set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { greenLed }]; #IO_L9N_T1_DQS_34 Sch=led0_g
set_property -dict { PACKAGE_PIN F2    IOSTANDARD LVCMOS33 } [get_ports { redLed }]; #IO_L10P_T1_34 Sch=led0_r
