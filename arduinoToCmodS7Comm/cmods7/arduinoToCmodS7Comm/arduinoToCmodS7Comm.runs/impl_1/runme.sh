...
HD_PWD='C:/Xilinx/workspace/arduinoToCmodS7Comm/arduinoToCmodS7Comm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log echoBlock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source echoBlock.tcl -notrace
