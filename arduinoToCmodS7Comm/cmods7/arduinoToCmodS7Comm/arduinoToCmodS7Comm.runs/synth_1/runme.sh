...
HD_PWD='C:/Xilinx/workspace/arduinoToCmodS7Comm/arduinoToCmodS7Comm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log echoBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source echoBlock.tcl
